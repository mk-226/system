...
function Sidebar({ showDropdown, setShowDropdown }) {
  ...
  return (
    <>
      ...
      <aside id="layout-menu" className={showDropdown ? "layout-menu menu-vertical menu bg-menu-theme d-block" : "d-none"}>
        <button className='sidebar-show btn btn-priamry' style={{ width: '100%', textAlign: "end" }}
          onClick={() => {
            console.log("a");

            setShowDropdown(!showDropdown)
          }}><FontAwesomeIcon icon={faAnglesRight} style={{ verticalAlign: "middle", color: "#697a8d" }}></FontAwesomeIcon></button>
