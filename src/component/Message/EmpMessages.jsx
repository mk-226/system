    ...
    <div style={{ marginTop: "1rem" }} >
      ...
      <div className="card" style={{ marginTop: "3rem" }}>
        ...
        <DataTable value={
                ...
                <div class="modal-dialog" style={{ width: "38%", transform: "translate(20%, 2%)" }}>
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="staticBackdropLabel">رسالة من : {message.emp.name}</h5>
                    ...
                    <div class="modal-body">
                      {
                        !massage.res ? <Editor readOnly={false} onTextChange={(e) => setMassageres(e.htmlValue.replace(/<[^>]+>/g, ''))} style={{ height: '160px' }} /> : <Editor value={massage.res} readOnly style={{ height: '160px', backgroundColor: "#e8e8e8" }} />
                      }
                      ...
                      massage.res == "" ? <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onClick={() => {
                          ...
                          if (Massageres === "") {
                            ...
                            fetch("http://localhost:3001/meassgestoadmin/" + massage.id, {
                              method: "PUT",
                              headers: {
                              ...
                              body: JSON.stringify({
                                emp: { name: message.emp.name, id: message.emp.id },
          ...
          <Column field="tores" header="" style={{ width: '25%' }} sortable filter filterPlaceholder="Search"></Column>
